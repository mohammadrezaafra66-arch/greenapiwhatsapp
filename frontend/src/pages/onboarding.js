...
export const PHASE_CONTENT = {
  ...
  gate_b_wait: {
    step: 3,
    title: "مرحلهٔ ۳ — انتظار پیش از اتصال به سرویس",
    body:
      "در این ۲۴ ساعت، این شماره را طبیعی روی گوشی استفاده کنید — هنوز به سرویس وصل نکنید.",
    locked: true,
  },
  connect_green_api: {
    step: 4,
    title: "مرحلهٔ ۴ — اتصال به سرویس و همکاری تیمی",
    body:
      "حالا وارد سرویس شوید، این شماره را با اسکن QR وصل کنید، سپس دکمهٔ «همکاری تیمی» را " +
      "برای این اکانت فعال کنید.",
    locked: false,
    action: "به سرویس وصل شد",
  },
  done: {
    step: 4,
    title: "راه‌اندازی کامل شد ✓",
    body: "این شماره با موفقیت راه‌اندازی و به سرویس متصل شد. می‌توانید همکاری تیمی را مدیریت کنید.",
    locked: false,
  },
};
